  ...
  return (
    <div className="relative mt-2" ref={ref}>
      <Listbox value={value} onChange={handleSelection}>
        <ListboxButton
          className="relative cursor-default bg-gray-50 border border-gray-300 text-gray-900 text-[16px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-2"
          onClick={() => {
            setIsOpen(!isOpen)
          }}
        >
